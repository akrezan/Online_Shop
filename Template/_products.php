                    ...
                    <div class="col">
                        ...
                        if(isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true){
                            if (in_array($item['item_id'], $Cart->getCartId($product->getUserData('cart')) ?? [])){
                                ...
                                echo '<button type="submit" name="product_submit" class="btn btn-success font-size-16 form-control">Add to Cart</button>';
                            }
                          }else{
                              //redirect  to login 
                              echo '<a href="login.php" class="btn btn-success font-size-16 form-control">Add to Cart</a>';
                          }
